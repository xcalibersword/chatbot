...
actions = {
    ...
    "bot.inform.price":["目前政策：每月社保最低缴费2035.8元（按最低基数4699），公积金338元（按基数2420），服务费两项一起80元； 注意：小店代缴社保为微利服务，所以不能用信用卡支付。如果需要用信用卡，要额外支付一倍的手续费哦，谢谢亲的配合~"],
    "bot.inform.procedure_material":["40的拍2份 亲，请注意小店代缴社保为微利服务，建议用支付宝余额或者储蓄卡支付，如果要用信用卡，要额外支付一倍的手续费哦，谢谢亲的配合~ 付款后用weixin小程序填写在线填写哦，主要内容是身份证照片 联系电话 邮箱 户籍地址 公积金账号"],
