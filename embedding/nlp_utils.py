...
test_set = [
    ...
    ("我要交本月社保杭州的，请问怎么去下单","request_link"),
    ...
    ("需要什么额外东西吗","query_req_resources"),
    ("要参保的话需要什么资料","query_req_resources"),
    ("那么代缴这个月的杭州社保要什么材料吗？","query_req_resources"),
    ("[link]还要我给什么资料吗","query_req_resources"),
    ("一般来说什么时候能查到","query_when_check_shebao_status"),
    ("我买了以后要多久能查到呢？","query_when_check_shebao_status"),
